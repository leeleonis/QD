...
namespace QDLogistics.Controllers
{
    public class TestController : Controller
    {
        ...
        public void DHL_Test(int OrderID)
        {
            ...
            IRepository<Orders> Orders = new GenericRepository<Orders>(db);
            Orders order = Orders.Get(OrderID);
            Packages package = order.Packages.First(p => p.IsEnable.Equals(true));

            DHL_API DHL = new DHL_API(package.Carriers.CarrierAPI);
        ...
        public void FedEx_Test(int OrderID)
        {
            ...
            FedEx_API FedEx = new FedEx_API(order.Packages.First(p => p.IsEnable.Equals(true)).Carriers.CarrierAPI);
