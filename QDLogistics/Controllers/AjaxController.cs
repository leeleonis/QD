...
namespace QDLogistics.Controllers
{
    public class AjaxController : Controller
    {
        ...
        public ActionResult OrderData(DataFilter filter, int page = 1, int rows = 100)
        {
            ...
            if (!string.IsNullOrWhiteSpace(filter.SourceID)) OrderFilter = OrderFilter.Where(o => (o.OrderSource.Value.Equals(1) && (o.eBaySalesRecordNumber.Equals(filter.SourceID) || o.OrderSourceOrderId.Contains(filter.SourceID))) || (!o.OrderSource.Value.Equals(1) && o.OrderSourceOrderId.Equals(filter.SourceID)));
