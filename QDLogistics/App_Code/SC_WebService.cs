...
namespace SellerCloud_WebService
{
    public class SC_WebService : IDisposable
    {
        ...
        {
            return PO_SellerCloud.RMA_ReceiveItem_New2(PO_AuthHeader, RMAID, RMAItemID, ProductID, QtyToReceive, DestinationBinName, WarehouseID, SerialsList, QtyReturnedDoNotCount, DateTime.Now.AddDays(3), "");
        }
