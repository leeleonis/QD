    ...
    public class TrackOrder
    {
        ...
        public TrackResult track()
        {
            ...
            try
            {
                ...
                result.DeliveryStatus = (int)OrderService.DeliveryStatusType.UnShipped;
                ...
                switch (_carrier.Name)
                {
                    case "DHL":
                        ...
                        TrackingResponse DHL_Result = DHL.Tracking(_trackingNumber);
                        ...
                        break;
                    case "FedEx":
                        FedEx_API FedEx = new FedEx_API(_carrier.CarrierAPI);
                        TrackReply FedEx_Result = FedEx.Tracking(_trackingNumber);
